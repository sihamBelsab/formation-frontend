...
import { Button, Form, Row, Col, Container, Card, Badge, Spinner, ListGroup, Alert, Modal } from "react-bootstrap";
import {
  FaChalkboardTeacher,
  FaBuilding,
  FaUsers,
...
function EvaluationFroid({ userInfo }) {
  ...
  const API_BASE_URL = "http://localhost:5000/api/evaluation-froid";
  ...
  const sectionTitle = (icon, text) => (
    <div className="d-flex align-items-center mb-4">
      ...
      <h4 className="mb-0" style={{ color: secondaryColor }}>{text}</h4>
    </div>
  );
        ...
        <Modal.Body>
          <Row className="mb-3">
            <Col md={6}>
              ...
              <p><strong>Name:</strong> {evaluation.nom} {evaluation.prenom}</p>
              <p><strong>Matricule:</strong> {evaluation.matricule}</p>
            </Col>
            <Col md={6}>
              <h6>Evaluation Information</h6>
              <p><strong>Date:</strong> {new Date(evaluation.date_evaluation).toLocaleDateString()}</p>
              <p><strong>Note:</strong> {evaluation.note}%</p>
              <p><strong>Service:</strong> {evaluation.service}</p>
            </Col>
          </Row>
          ...
          <Row className="mb-3">
            <Col>
              ...
              <p><strong>Formation:</strong> {evaluation.formation_titre || evaluation.formation_theme || 'N/A'}</p>
              <p><strong>Date de début:</strong> {evaluation.formation_date_debut || 'N/A'}</p>
              <p><strong>Date de fin:</strong> {evaluation.formation_date_fin || 'N/A'}</p>
            </Col>
          </Row>
          ...
          <Row className="mb-3">
            <Col>
              <h6>Questions</h6>
              <div className="mb-3">
                <p><strong>Pourquoi le recours à cette formation ?</strong></p>
                <p className="text-muted">{evaluation.question1}</p>
              </div>
              <div className="mb-3">
                <p><strong>Source du besoin</strong></p>
                <p className="text-muted">{evaluation.question2}</p>
              </div>
              <div className="mb-3">
                <p><strong>Précisez</strong></p>
                <p className="text-muted">{evaluation.question3}</p>
              </div>
              <div className="mb-3">
                <p><strong>Objectif pour le collaborateur</strong></p>
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="mb-0 opacity-75">Évaluation différée - à remplir après période d'application terrain</p>
            </div>
            {/* <Badge pill bg="light" text="dark" className="px-3 py-2">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div className="note-moyenne-container">
                  <h4 className="mb-0" style={{ color: secondaryColor }}>Note moyenne: {calculateAverage()}%</h4>
                </div>
            </div>
              ...
              <table className="table table-hover align-middle">
                <thead>
                  <tr style={{ backgroundColor: lightBg }}>
                    ...
                    <th style={{ width: "30%", color: secondaryColor, textAlign: "center" }}>Satisfaction</th>
                  </tr>
                </thead>
                <tbody>
